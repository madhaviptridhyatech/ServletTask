				...
				<div class="card shadow-2-strong card-registration"
					...
					<div class="card-body p-4 p-md-5">
						<h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-primary">
							<center>Update User Form by Admin</center>
						</h3>
						<c:forEach var="user" items="${userData}">
							<form action="updateUserInAdmin" method="post" id="updateUserForm">
								<div class="row">
									<div class="col-md-6 mb-4">
										<div class="form-outline">
											<label class="form-label">First Name</label> <input
												type="text" id="firstName" name="firstName"
												class="form-control form-control" for="firstName"
									...
									<div class="col-md-6 mb-4 pb-2">
										...
										<div class="form-outline">
											<label class="form-label">Email</label> <input type="text"
												id="email" name="email" class="form-control form-control"
								...
								<div class="row">
									...
									<div class="mt-4 pt-2">
										<input class="btn btn-primary btn-lg" style="width: 100%;" value="Save" type="submit">
									</div>
							</form>
						</c:forEach>
					</div>
